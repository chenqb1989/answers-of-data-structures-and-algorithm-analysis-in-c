/*
note:
1. note to free the deleted element
2. time: O(N^2)
*/
#include <stdlib.h>
#include <stdio.h>
...
int append(t_list lst, int elem)
{
    ...
    t_position tmp_cell1 = (t_position)malloc(sizeof(t_position));
...
int del_duplicate_list(t_list lst)
{
    if (lst == NULL)
        return 0;
